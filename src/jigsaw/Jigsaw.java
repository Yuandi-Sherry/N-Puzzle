...
public abstract class Jigsaw {
    ...
    public Jigsaw() {
        ...
        try {
            out = new FileWriter (new File("111.txt"));
            out.write("fu??");
        }
    ...
    public final boolean ASearch(JigsawNode bNode, JigsawNode eNode) {
        ...
        while (this.searchedNodesNum < MAX_NODE_NUM && !this.exploreList.isEmpty()) {
            ...
            /*if(currentJNode.getParent() != null)
            if(currentJNode.getEstimatedValue() < currentJNode.getParent().getEstimatedValue()) {
                System.out.println("Error1");
                System.out.println(currentJNode.getEstimatedValue());
            
                System.out.println("parent " + currentJNode.getParent().getEstimatedValue());
            }*/
            //System.out.println(currentJNode.getEstimatedValue());
        ...
        // System.out.println("Solution Path: ");
        // System.out.println(this.getSolutionPath());
        System.out.println(this.getSearchedNodesNum());
